...
public class DateTimeInfoExample {
	...
	public static void main(String[] args) {
		...
		strDateTime += now.getMonth().getValue()+"월";
		...
		if(nowDate.isLeapYear()) {//
			System.out.println("올해는 윤년: 2월은 29일 까지 입니다.");
		}else {
			System.out.println(" 올해는 평년: 2월은 28일 까지 입니다.");
		}
		...
		System.out.println("서울 오프셋:"+ seoulZoneOffset);
